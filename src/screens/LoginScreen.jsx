      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.logoBlock}>
            ...
            <Text style={styles.logoSub}>See · Scan · Understand</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  logoBlock: { alignItems: "center", paddingTop: 52, paddingBottom: 36 },
  logoCircle: {
    width: 72, height: 72, borderRadius: 20,
    backgroundColor: "#EEF0FF", alignItems: "center",
    justifyContent: "center", marginBottom: 14,
  },
  logoText: { fontSize: 24, fontWeight: "700", color: "#D97757", letterSpacing: -0.3 },
  logoSub: { fontSize: 12, color: "#9E9E9E", marginTop: 4, letterSpacing: 0.5 },
  ...
  forgotText: { fontSize: 12, color: "#D97757", fontWeight: "600" },
